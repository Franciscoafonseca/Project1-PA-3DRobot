!(function () {
  ...
  const t = "15.0.2",
    ...
    o = (t, e, { startTime: n, target: s, timeConstant: i }) =>
      s + (e - s) * Math.exp((n - t) / i),
    r = (t) => "exponentialRampToValue" === t.type,
    a = (t) => "linearRampToValue" === t.type,
    c = (t) => r(t) || a(t),
    h = (t) => "setValue" === t.type,
    u = (t) => "setValueCurve" === t.type,
    l = (t, e, n, s) => {
      const i = t[e];
      return void 0 === i
        ? s
        ...
        : c(n)
          ...
          : h(n)
            ...
            : u(n)
              ...
              : [n.startTime, l(t, e - 1, n.startTime, i)],
    p = (t) => "cancelAndHold" === t.type,
    f = (t) => "cancelScheduledValues" === t.type,
    m = (t) =>
      p(t) || f(t) ? t.cancelTime : r(t) || a(t) ? t.endTime : t.startTime,
    _ = (t, e, n, { endTime: s, value: i }) =>
      n === i
        ? i
        : (0 < n && 0 < i) || (n < 0 && i < 0)
          ? n * (i / n) ** ((t - e) / (s - e))
          : 0,
    g = (t, e, n, { endTime: s, value: i }) =>
      n + ((t - e) / (s - e)) * (i - n),
    v = (t, { duration: e, startTime: n, values: s }) =>
      ((t, e) => {
        const n = Math.floor(e),
          s = Math.ceil(e);
        return n === s ? t[n] : (1 - (e - n)) * t[n] + (1 - (s - e)) * t[s];
      })(s, ((t - n) / e) * (s.length - 1)),
    y = (t) => "setTarget" === t.type;
  class x {
    constructor(t) {
    ...
    add(t) {
      const o = m(t);
      if (p(t) || f(t)) {
        const a = this._automationEvents.findIndex((e) =>
            f(t) && u(e) ? e.startTime + e.duration >= o : m(e) >= o,
          ),
          h = this._automationEvents[a];
        if (
          (-1 !== a &&
            (this._automationEvents = this._automationEvents.slice(0, a)),
          p(t))
        ) {
              ...
              i =
                void 0 === t
                  ...
                  : u(t)
                    ...
                    : t.value,
              a = r(h) ? _(o, s, i, h) : g(o, s, i, h),
              c = r(h) ? e(a, o, this._currenTime) : n(a, o, this._currenTime);
            this._automationEvents.push(c);
          }
          if (
            (void 0 !== t &&
              y(t) &&
              this._automationEvents.push(s(this.getValue(o), o)),
            void 0 !== t && u(t) && t.startTime + t.duration > o)
          ) {
            const e = o - t.startTime,
              n = (t.values.length - 1) / t.duration,
              s = Math.max(2, 1 + Math.ceil(e * n)),
              r = (e / (s - 1)) * n,
              a = t.values.slice(0, s);
            if (r < 1)
              for (let e = 1; e < s; e += 1) {
                const n = (r * e) % 1;
                a[e] = t.values[e - 1] * (1 - n) + t.values[e] * n;
              }
            this._automationEvents[this._automationEvents.length - 1] = i(
              a,
              t.startTime,
              e,
            );
        ...
        if (void 0 !== i && u(i) && m(i) + i.duration > o) return !1;
        const c = r(t)
          ? e(t.value, t.endTime, this._currenTime)
          : a(t)
            ? n(t.value, o, this._currenTime)
            : t;
        if (-1 === s) this._automationEvents.push(c);
        else {
          if (u(t) && o + t.duration > m(this._automationEvents[s])) return !1;
    ...
    flush(t) {
      ...
      if (e > 1) {
        const t = this._automationEvents.slice(e - 1),
          n = t[0];
        (y(n) &&
          t.unshift(
            s(
              l(this._automationEvents, e - 2, n.startTime, this._defaultValue),
              n.startTime,
            ),
          ),
    ...
    getValue(t) {
      ...
      if (void 0 !== i && y(i) && (void 0 === n || !c(n) || n.insertTime > t))
        return o(
          t,
          l(this._automationEvents, s - 1, i.startTime, this._defaultValue),
          i,
        );
      if (void 0 !== i && h(i) && (void 0 === n || !c(n))) return i.value;
      if (
        void 0 !== i &&
        u(i) &&
        (void 0 === n || !c(n) || i.startTime + i.duration > t)
      )
  ...
  const w = new WeakSet(),
    ...
    Z = () => new DOMException("", "IndexSizeError"),
    G = (t) => {
      var e;
      t.getChannelData =
        ((e = t.getChannelData),
    ...
    ft = (t, e, n, s) => {
      ht(e) ? t.disconnect(e.inputs[s], n, 0) : t.disconnect(e, n, s);
    },
    mt = (t) => P(b, t),
    _t = (t) => P(A, t),
    gt = (t) => O.has(t),
    ...
    wt = (t) => "context" in t,
    Tt = (t, e, n, s) => {
      const { activeInputs: i, passiveInputs: o } = et(e),
        { outputs: r } = tt(t),
        a = B(t),
        c = (r) => {
          const a = mt(t),
          ...
          if (r) {
            ...
            const e = ((t, e, n) => F(t, (t) => t[0] === e && t[1] === n))(
              i,
              t,
              n,
            );
      ...
      return (
        !!rt(r, [e, n], (t) => t[0] === e && t[1] === n, !0) &&
        (a.add(c), J(t) ? at(i, t, [n, c], !0) : ct(o, [t, n, c], !0), !0)
      );
    },
    bt = (t, e, n, s, i) => {
      const [o, r] = ((t, e, n, s) => {
        const { activeInputs: i, passiveInputs: o } = tt(e),
          r = lt(i[s], t, n);
        if (null === r) return [q(o, t, n, s)[2], !1];
        return [r[2], !0];
      })(t, n, s, i);
      if (
        (null !== o && (dt(t, o), !r || e || gt(t) || ft(mt(t), mt(n), s, i)),
        J(n))
      ) {
    ...
    Ct = (t, e, n, s) => {
      const [i, o] = ((t, e, n) => {
        const { activeInputs: s, passiveInputs: i } = et(e),
          o = lt(s, t, n);
  ...
  const Ot = (t, e, n, s, i) => {
    ...
    Dt = async (t, e, n, s, i, o, r) => {
      const a = null === e ? 128 * Math.ceil(t.context.length / 128) : e.length,
        ...
        u = 0 === h ? null : n.createBuffer(h, a, n.sampleRate);
      ...
      const l = tt(t),
        ...
        p = Mt(s.numberOfInputs, s.channelCount),
        f = Mt(s.numberOfOutputs, i),
      ...
      for (let h = 0; h < a; h += 128) {
        if (s.numberOfInputs > 0 && null !== e)
          for (let t = 0; t < s.numberOfInputs; t += 1)
            for (let n = 0; n < s.channelCount; n += 1) kt(e, p[t], n, n, h);
        void 0 !== o.parameterDescriptors &&
          null !== e &&
          o.parameterDescriptors.forEach(({ name: t }, n) => {
            kt(e, m, t, c + n, h);
          });
        for (let t = 0; t < s.numberOfInputs; t += 1)
        ...
        try {
          const t = p.map((t, e) => (0 === l.activeInputs[e].size ? [] : t)),
            e = r(h / n.sampleRate, n.sampleRate, () => d.process(t, f, m));
          if (null !== u)
            for (let t = 0, e = 0; t < s.numberOfOutputs; t += 1) {
              for (let n = 0; n < i[t]; n += 1) Ot(u, f[t], n, e + n, h);
              e += i[t];
            }
          if (!e) break;
        } catch (e) {
    ...
    zt = () => new DOMException("", "InvalidAccessError"),
    Lt = {
      channelCount: 2,
      channelCountMode: "max",
      channelInterpretation: "speakers",
    },
    Ut = (t, e, n, s, i, o, r, a, c, h, u) => {
      const l = h.length;
      let d = a;
      for (let a = 0; a < l; a += 1) {
        let l = n[0] * h[a];
    ...
    Gt = (t, e) => {
      (Zt(t, e, "channelCount"),
        Zt(t, e, "channelCountMode"),
        Zt(t, e, "channelInterpretation"));
    },
    $t = (t) => "function" == typeof t.getFloatTimeDomainData,
    Ht = (t, e, n) => {
      const s = e[n];
  ...
  const ce = (t, e, n, s) => t.createScriptProcessor(e, n, s),
    he = () => new DOMException("", "NotSupportedError"),
    ue = { numberOfChannels: 1 },
    le = {
      channelCount: 2,
      channelCountMode: "max",
      channelInterpretation: "speakers",
    ...
    Se = (
      ...
      (e, n, [s, i, o], r) => {
        const a = e.get(s);
        void 0 === a
          ? e.set(s, new Set([[i, n, o]]))
          : t(a, [i, n, o], (t) => t[0] === i && t[1] === n, r);
      }
    )(rt),
    ke = (
      (t) => (e, n, s, i) =>
      ...
      (t, e) => {
        ...
        try {
          ...
          return n instanceof Promise
            ? (Ie.set(t, n),
              n.catch(() => !1).then((e) => (Ie.delete(t), Ee.set(t, e), e)))
            : (Ee.set(t, n), n);
        } catch {
          return (Ee.set(t, !1), !1);
        }
  ...
  var Ie, Ee;
  const Re = "undefined" == typeof window ? null : window,
    Ne = ((t, e) => (n, s) => {
          ...
          .map((t, r) =>
            Array.from(t).map(async ([t, a]) => {
              const c = e(t),
                ...
                u = s.context.destination;
              n(t) || (s === u && n(s)) || h.connect(o, a, r);
            }),
          )
          .reduce((t, e) => [...t, ...e], []),
      );
    ...
    Ge = ((t) =>
      null === t
        ...
        : t.hasOwnProperty("AudioWorkletNode")
          ? t.AudioWorkletNode
          : null)(Re),
    $e = ((t, e, n, s, i, o, r, a, c, h, u, l, d, p, f, m) =>
      class extends h {
        constructor(e, s, i, o) {
        ...
        connect(t, n = 0, a = 0) {
          ...
          if (it(t)) {
            const i = mt(t);
            try {
              const e = ut(this._nativeAudioNode, i, n, a),
                s = vt(this);
              ((l || s) && this._nativeAudioNode.disconnect(...e),
                "closed" !== this.context.state && !s && vt(t) && W(t));
            } catch (t) {
          ...
          try {
            (this._nativeAudioNode.connect(m, n),
              (l || vt(this)) && this._nativeAudioNode.disconnect(m, n));
          } catch (t) {
            if (12 === t.code) throw o();
            throw t;
          }
          ...
          if (void 0 === t)
            s = ((t, e) => {
              ...
              for (const i of n.outputs)
                (ot(i) ? bt(t, e, ...i) : Ct(t, e, ...i), s.push(i[0]));
            ...
            if (it(t) && void 0 !== n && (n < 0 || n >= t.numberOfInputs))
              throw i();
            if (
              ((s = ((t, e, n, s, i) => {
                const o = tt(t);
      ...
      ((t, e, n, s, i, o, r, a, c, h, u, l, d) => {
        const p = new WeakMap();
        return (f, m, _, g, v) => {
          const { activeInputs: y, passiveInputs: x } = o(m),
            { outputs: w } = o(f),
            T = a(f),
            b = (o) => {
              const a = c(m),
              ...
              if (o) {
                const e = q(x, f, _, g);
                (t(y, f, e, !1), v || l(f) || n(h, a, _, g), d(m) && W(m));
              } else {
                const t = s(y, f, _, g);
                (e(x, g, t, !1), v || l(f) || i(h, a, _, g));
                const n = r(m);
                if (0 === n) u(m) && L(m, y);
                else {
                  const t = p.get(m);
          ...
          return (
            ...
            (T.add(b),
            u(f) ? t(y, f, [_, g, b], !0) : e(x, g, [f, _, b], !0),
            !0)
          );
        };
      })(Ae, Se, ut, ke, ft, tt, Me, B, mt, rt, J, gt, vt),
      De,
      ((t, e, n, s, i, o) => (r) => (a, c) => {
        const h = t.get(a);
        if (void 0 === h) {
  ...
  const nn = ((t, e) => (n) => {
    ...
    on = ((t, e, n, s, i, o, r, a) => {
      ...
      return class h {
        constructor(h) {
          ...
          const p =
            null !== s && e(o, o)
              ? new s({ length: u, numberOfChannels: l, sampleRate: d })
              : c.createBuffer(l, u, d);
          if (0 === p.numberOfChannels) throw n();
          return (
            "function" != typeof p.copyFromChannel
              ? (r(p), G(p))
              : e(Y, () => Y(p)) || a(p),
            t.add(p),
            p
    ...
    an = ((t, e, n) => async (s, i, o) => {
      const r = e(s);
      await Promise.all(
        Array.from(r.activeInputs).map(async ([e, s]) => {
          const r = t(e),
    ...
    un = ((t, e) => (n, s, i) => (t(s).replay(i), e(s, n, i)))(
      ((t) => (e) => {
        const n = t(e);
        if (null === n.renderer)
          throw new Error(
          ...
          return void 0 !== u
            ...
            : (async (c, h) => {
                ...
                return (
                  o.set(h, u),
                  l
                    ? await t(h, c.playbackRate, u.playbackRate)
                    : await s(h, c.playbackRate, u.playbackRate),
                  await i(c, h, u),
                  u
                );
              })(c, h);
    ...
    dn = (
          ...
          T = {
            ...
            cancelAndHoldAtTime(t) {
              if ("function" == typeof m.cancelAndHoldAtTime)
                (null === w && y.flush(p.context.currentTime),
                  y.add(i(t)),
            ...
            exponentialRampToValueAtTime(t, e) {
              ...
              return (
                ...
                0 === Array.from(y).length &&
                  (y.add(h(v, n)), m.setValueAtTime(v, n)),
                y.add(r(t, e)),
            ...
            setValueCurveAtTime(t, e, n) {
              ...
              if (null !== l && "webkitAudioContext" === l.name) {
                ...
                const h = r / i;
                (h < t && d(T, c[c.length - 1], h), d(T, s[s.length - 1], t));
              } else
                (null === w && y.flush(p.context.currentTime),
                  y.add(u(s, e, n)),
                  m.setValueCurveAtTime(s, e, n));
              return T;
            },
          };
      ...
      (t) => ({ cancelTime: t, type: "cancelAndHold" }),
      (t) => ({ cancelTime: t, type: "cancelScheduledValues" }),
      (t, e) => ({ endTime: e, type: "exponentialRampToValue", value: t }),
      (t, e) => ({ endTime: e, type: "linearRampToValue", value: t }),
      (t, e, n) => ({
        startTime: e,
        target: t,
        timeConstant: n,
  ...
  const fn = ((t, e, n, s, i, o, r, a) =>
      class extends t {
        constructor(t, s) {
          ...
          (super(t, !1, h, l),
            ...
            (this._onended = null),
            (this._playbackRate = n(this, u, h.playbackRate, Q, H)));
        }
        get buffer() {
            ...
            : (async (r, a) => {
                ...
                return (
                  ...
                  h
                    ...
                    : (await s(a, r.Q, c.Q),
                      await s(a, r.detune, c.detune),
                      await s(a, r.frequency, c.frequency),
                      await s(a, r.gain, c.gain)),
                  await i(r, a, c),
                  c
                );
              })(r, a);
      ...
      class extends t {
        constructor(t, s) {
          ...
          (super(t, !1, u, l ? n() : null),
            ...
            (this._frequency = e(this, l, u.frequency, t.sampleRate / 2, 0)),
            (this._gain = e(this, l, u.gain, 40 * Math.log10(Q), H)),
    ...
    yn = ((t, e) => (n, s, i) => {
      ...
      return (
        ...
        (n.disconnect = ((t) => (s, r, a) => {
          const c = o.size > 0;
          if (void 0 === s) (t.apply(n), o.clear());
          else if ("number" == typeof s) {
            t.call(n, s);
          ...
          return void 0 !== u
            ...
            : (async (c, h) => {
                ...
                return (
                  o.set(h, u),
                  l
                    ? await t(h, c.offset, u.offset)
                    : await s(h, c.offset, u.offset),
                  await i(c, h, u),
                  u
                );
              })(c, h);
      ...
      class extends t {
        constructor(t, r) {
          ...
          (super(t, !1, h, l),
            ...
            (this._offset = e(this, u, h.offset, Q, H)),
            (this._onended = null));
        }
        get offset() {
          return this._offset;
        ...
        render(i, o) {
          ...
          return void 0 !== r
            ...
            : (async (i, o) => {
                ...
                return (
                  s.set(o, r),
                  ht(r) ? await n(i, o, r.inputs[0]) : await n(i, o, r),
                  r
                );
              })(i, o);
        },
      ...
      class extends t {
        constructor(t, a) {
          const c = i(t),
            ...
            u = s(c, h),
            l = o(c);
          (super(t, !1, u, l ? n(h.maxDelayTime) : null),
            ...
            : (async (r, a) => {
                ...
                return (
                  ...
                  h
                    ...
                    : (await s(a, r.attack, c.attack),
                      await s(a, r.knee, c.knee),
                      await s(a, r.ratio, c.ratio),
                      await s(a, r.release, c.release),
                      await s(a, r.threshold, c.threshold)),
                  await i(r, a, c),
                  c
                );
              })(r, a);
        ...
        render(r, a) {
          ...
          return void 0 !== c
            ...
            : (async (r, a) => {
                ...
                return (
                  o.set(a, c),
                  h ? await t(a, r.gain, c.gain) : await s(a, r.gain, c.gain),
                  await i(r, a, c),
                  c
                );
              })(r, a);
      ...
      class extends t {
        constructor(t, r) {
          ...
          (super(t, !1, h, u ? n() : null),
            (this._gain = e(this, u, h.gain, Q, H)));
        }
        get gain() {
          return this._gain;
        }
    ...
    Wn = (
      ...
      (
        ...
        const l = Kt(o, i.sampleRate),
          d = h instanceof Float64Array ? h : new Float64Array(h),
            ...
            getFrequencyResponse(e, n, s) {
              ...
              for (let t = 0; t < i; t += 1) {
                const i = -Math.PI * (e[t] / w),
                  ...
                  r = re(ae(p, o), ae(d, o));
                ((n[t] = Math.sqrt(r[0] * r[0] + r[1] * r[1])),
                  (s[t] = Math.atan2(r[1], r[0])));
              }
            },
            removeEventListener: (...t) =>
      ...
      const h = async (h, u) => {
        ...
        if (
          ...
          if (null === c) {
            ...
            c = (async () => {
              await s(h, t, t.destination);
              return ((t, e, n, s) => {
                const i = n instanceof Float64Array ? n : new Float64Array(n),
                  o = s instanceof Float64Array ? s : new Float64Array(s),
                  r = i.length,
                  a = o.length,
                  c = Math.min(r, a);
                if (1 !== i[0]) {
                ...
                for (let e = 0; e < d; e += 1) {
                  const n = t.getChannelData(e),
                    s = l.getChannelData(e);
                  (h.fill(0), u.fill(0), Ut(i, r, o, a, c, h, u, 0, 32, n, s));
                }
                return l;
              })(await i(t), u, o, r);
            })();
    ...
    Un = ((t, e, n, s, i, o) =>
      class extends t {
        constructor(t, r) {
          ...
          (super(t, !1, u, c ? n(h.feedback, h.feedforward) : null),
            ((t) => {
              var e;
          ...
          ? (() => {
              ...
              const g = () => {
                ...
                x = (e, s, o) => {
                  ...
                  const u = t({ context: c }, p, r.offset, Q, H);
                  var l, f, m, _, v, y, x;
                  return (
                    a(
                      u,
          ...
          return void 0 !== l
            ...
            : (async (h, u) => {
                ...
                return (
                  o.set(u, l),
                  d
                    ? (await t(u, h.detune, l.detune),
                      await t(u, h.frequency, l.frequency))
                    : (await s(u, h.detune, l.detune),
                      await s(u, h.frequency, l.frequency)),
                  await i(h, u, l),
                  l
                );
              })(h, u);
      ...
      class extends t {
        constructor(t, r) {
          ...
          (super(t, !1, h, l),
            ...
            (this._frequency = e(this, u, h.frequency, d, -d)),
    ...
    Jn = (
      ...
      (o, { curve: r, oversample: a, ...c }) => {
        ...
        return i(
          se(v, p),
          () => {
            (l.connect(h).connect(p),
              l.connect(d).connect(u).connect(f).connect(p),
              (_ = !0),
              s(g) && (m = t(o, l)));
          },
          () => {
    ...
    Kn = ((t, e, n, s, i, o, r) => (a, c) => {
      ...
      (Zt(h, { curve: u }, "curve"), Zt(h, c, "oversample"));
      let l = null,
        d = !1;
      r(
        h,
      ...
      return i(
        h,
        () => {
          ((d = !0), s(h.curve) && (l = t(a, h)));
        },
        () => {
          ((d = !1), null !== l && (l(), (l = null)));
        },
      );
    })(Qn, jt, Jn, ge, yn, Ue, ve),
    ts = (
      (t, e, n, s, i, o, r, a, c, h) =>
      (
        u,
        ...
        (l !== j.coneInnerAngle && (j.coneInnerAngle = l),
          d !== j.coneOuterAngle && (j.coneOuterAngle = d),
          p !== j.coneOuterGain && (j.coneOuterGain = p),
          f !== j.distanceModel && (j.distanceModel = f),
          m !== j.maxDistance && (j.maxDistance = m),
          _ !== j.orientationX.value && (j.orientationX.value = _),
          g !== j.orientationY.value && (j.orientationY.value = g),
          v !== j.orientationZ.value && (j.orientationZ.value = v),
          y !== j.panningModel && (j.panningModel = y),
          x !== j.positionX.value && (j.positionX.value = x),
          w !== j.positionY.value && (j.positionY.value = w),
          T !== j.positionZ.value && (j.positionZ.value = T),
          b !== j.refDistance && (j.refDistance = b),
          C !== j.rolloffFactor && (j.rolloffFactor = C),
          (1 === q[0] && 0 === q[1] && 0 === q[2]) || S.setOrientation(...q),
          (0 === B[0] && 0 === B[1] && 0 === B[2]) || S.setPosition(...B));
        return h(
          se(j, S),
          () => {
            (M.connect(S),
              t(M, F, 0, 0),
              F.connect(D).connect(O, 0, 0),
              F.connect(I).connect(O, 0, 1),
              F.connect(E).connect(O, 0, 2),
              F.connect(R).connect(O, 0, 3),
              F.connect(N).connect(O, 0, 4),
              F.connect(V).connect(O, 0, 5),
              O.connect(P).connect(u.destination));
          },
          () => {
            (M.disconnect(S),
              a(M, F, 0, 0),
              ...
              V.disconnect(O),
              O.disconnect(P),
              P.disconnect(u.destination));
          },
        );
      }
    )(ut, jt, wn, oe, ce, Kn, he, ft, _e, yn),
    es = ((t) => (e, n) => {
      ...
      return void 0 === s.orientationX
        ...
        : (Gt(s, n),
          ...
          Ht(s, n, "positionY"),
          Ht(s, n, "positionZ"),
          Zt(s, n, "coneInnerAngle"),
          Zt(s, n, "coneOuterAngle"),
          Zt(s, n, "coneOuterGain"),
          Zt(s, n, "distanceModel"),
          Zt(s, n, "maxDistance"),
          Zt(s, n, "panningModel"),
          Zt(s, n, "refDistance"),
          Zt(s, n, "rolloffFactor"),
          s);
    })(ts),
    ns = ((t, e, n, s, i, o, r, a, c, h) => () => {
      const u = new WeakMap();
      let l = null;
      return {
        render(d, p) {
          ...
          return void 0 !== f
            ...
            : (async (d, p) => {
                ...
                const _ = {
                  ...
                  v = X(m, p);
                if ("bufferSize" in m) f = s(p, { ..._, gain: 1 });
                else if (!v) {
                  const t = {
                    ...g,
                ...
                if ((u.set(p, null === f ? m : f), null !== f)) {
                  if (null === l) {
                    if (null === r)
                      throw new Error(
                        "Missing the native OfflineAudioContext constructor.",
                      );
                    const t = new r(6, d.context.length, p.sampleRate),
                      s = e(t, {
                        channelCount: 1,
                        channelCountMode: "explicit",
                        channelInterpretation: "speakers",
                ...
                return (
                  v
                    ? (await t(p, d.orientationX, m.orientationX),
                      await t(p, d.orientationY, m.orientationY),
                      await t(p, d.orientationZ, m.orientationZ),
                      await t(p, d.positionX, m.positionX),
                      await t(p, d.positionY, m.positionY),
                      await t(p, d.positionZ, m.positionZ))
                    : (await a(p, d.orientationX, m.orientationX),
                      await a(p, d.orientationY, m.orientationY),
                      await a(p, d.orientationZ, m.orientationZ),
                      await a(p, d.positionX, m.positionX),
                      await a(p, d.positionY, m.positionY),
                      await a(p, d.positionZ, m.positionZ)),
                  ht(m) ? await c(d, p, m.inputs[0]) : await c(d, p, m),
                  m
                );
              })(d, p);
        },
      };
    })(cn, wn, kn, oe, es, mt, We, un, Pe, jn),
    ss = ((t, e, n, s, i, o, r) =>
      class extends t {
        constructor(t, a) {
          const c = i(t),
          ...
          (super(t, !1, u, l ? s() : null),
            ...
            (this._orientationX = e(this, l, u.orientationX, Q, H)),
            (this._orientationY = e(this, l, u.orientationY, Q, H)),
            (this._orientationZ = e(this, l, u.orientationZ, Q, H)),
            (this._positionX = e(this, l, u.positionX, Q, H)),
            (this._positionY = e(this, l, u.positionY, Q, H)),
            (this._positionZ = e(this, l, u.positionZ, Q, H)),
            r(this, 1));
        }
        get coneInnerAngle() {
    ...
    rs = ((t, e, n, s, i, o) => {
          ...
          if (2 === o)
            return ((t, i, o, l) => {
              ...
              return {
                connectGraph() {
                  (i.connect(g),
                    i.connect(void 0 === T.inputs ? T : T.inputs[0]),
                    g.connect(v, 0),
                    g.connect(x, 0),
                    g.connect(b, 1),
                    g.connect(A, 1),
                    ...
                    o.connect(void 0 === C.inputs ? C : C.inputs[0]),
                ...
                disconnectGraph() {
                  (i.disconnect(g),
                    i.disconnect(void 0 === T.inputs ? T : T.inputs[0]),
                    g.disconnect(v, 0),
                    g.disconnect(x, 0),
                    g.disconnect(b, 1),
                    g.disconnect(A, 1),
                    ...
                    o.disconnect(void 0 === C.inputs ? C : C.inputs[0]),
      ...
      return (e, { channelCount: s, channelCountMode: r, pan: a, ...c }) => {
        ...
        const h = t(e, {
          ...
          u = n(e, { ...c, channelCount: s, channelCountMode: r, gain: 1 }),
          d = n(e, {
            channelCount: 1,
            channelCountMode: "explicit",
            channelInterpretation: "discrete",
        ...
        let { connectGraph: p, disconnectGraph: f } = l(e, s, u, d, h);
        ...
        const m = {
          ...
          set channelCount(t) {
            (u.channelCount !== t &&
              (_ && f(),
              ({ connectGraph: p, disconnectGraph: f } = l(e, t, u, d, h)),
              _ && p()),
              (u.channelCount = t));
          },
          get channelCountMode() {
        ...
        render(r, a) {
          ...
          return void 0 !== c
            ...
            : (async (r, a) => {
                ...
                return (
                  o.set(a, c),
                  h ? await t(a, r.pan, c.pan) : await s(a, r.pan, c.pan),
                  ht(c) ? await i(r, a, c.inputs[0]) : await i(r, a, c),
                  c
                );
              })(r, a);
        },
      ...
      class extends t {
        constructor(t, r) {
          const a = i(t),
            ...
            h = n(a, c),
            u = o(a);
          (super(t, !1, h, u ? s() : null), (this._pan = e(this, u, h.pan)));
        }
        get pan() {
          return this._pan;
        }
    ...
    ds = ((t) => null !== t && t.isSecureContext)(Re),
    ps = ((t) => (e, n, s) => {
    ...
    _s = ds
      ? ((t, e, n, s, i, o, r, a, c, h, u, l, d) => {
          ...
          return (f, m, _ = { credentials: "omit" }) => {
            ...
            const y = o(f),
              x =
                void 0 === y.audioWorklet
                  ? i(m)
                      .then(([t, e]) => {
                        const [s, i] = R(t, e);
                        return n(
                          `${s};((a,b)=>{(a[b]=a[b]||[]).push((AudioWorkletProcessor,global,registerProcessor,sampleRate,self,window)=>{${i}\n})})(window,'_AWGS')`,
                        );
                      })
                      .then(() => {
                        const t = d._AWGS.pop();
                        if (void 0 === t) throw new SyntaxError();
                        s(y.currentTime, y.sampleRate, () =>
                          t(
                            class {},
                            void 0,
                            (t, n) => {
                              ...
                              if (void 0 !== s) {
                                if (s.has(t)) throw e();
                                (V(n), N(n.parameterDescriptors), s.set(t, n));
                              } else
                                (V(n),
                                  N(n.parameterDescriptors),
                                  M.set(y, new Map([[t, n]])));
                            },
                            y.sampleRate,
                            void 0,
                  ...
                  : Promise.all([i(m), Promise.resolve(t(l, l))]).then(
                      ([[t, e], n]) => {
                        const s = p + 1;
                        p = s;
                        const [i, o] = R(t, e),
                        ...
                        return y.audioWorklet
                          ...
                          .then(() => {
                            if (a(y)) return y;
                            const t = r(y);
                            return t.audioWorklet.addModule(u, _).then(() => t);
                          })
                          .then((t) => {
            ...
            return (
              void 0 === v ? h.set(f, new Map([[m, x]])) : v.set(m, x),
              x
                .then(() => {
                  const t = u.get(f);
                  void 0 === t ? u.set(f, new Set([m])) : t.add(m);
                })
                .finally(() => {
                  const t = h.get(f);
                  void 0 !== t && t.delete(m);
        ...
        : new Promise((e, n) => {
            ...
            try {
              p.decodeAudioData(
                d,
                (n) => {
                  ("function" != typeof n.copyFromChannel && (h(n), G(n)),
                    t.add(n),
                    i().then(() => e(n)));
                },
                (t) => {
    ...
    ys = ((t, e, n, s, i, o, r, a, c, h, u, l, d, p, f, m, _, g, v, y) =>
      class extends f {
        constructor(e, n) {
          (super(e, n),
    ...
    xs = ((t, e, n, s) =>
      ...
      })($e, (t, e) => t.createMediaElementSource(e.mediaElement), qe, je),
    ws = ((t, e, n, s) =>
      class extends t {
        constructor(t, i) {
          const o = n(t);
          ...
          : "number" == typeof n
            ...
            : wt(n)
              ? void 0 === s
                ...
                : void 0 === i
                  ? qt(t, e, s).disconnect(n, 0)
                  : qt(t, e, s).disconnect(n, 0, i)
              : void 0 === s
                ? e.forEach((t) => t.disconnect(n))
                : qt(t, e, s).disconnect(n, 0)
    )(Z),
    ...
    Rs = ((t, e, n, s, i, o, r, a, c, h, u, l, d) => (p, f, m, _) => {
      if (0 === _.numberOfInputs && 0 === _.numberOfOutputs) throw c();
      const g = Array.isArray(_.outputChannelCount)
      ...
      const v = _.channelCount * _.numberOfInputs,
        y = g.reduce((t, e) => t + e, 0),
        x =
          void 0 === m.parameterDescriptors ? 0 : m.parameterDescriptors.length;
      ...
      const A = s(p, {
        ...
        M = [];
      for (let t = 0; t < _.numberOfOutputs; t += 1)
        M.push(
          s(p, {
            channelCount: 1,
            channelCountMode: "explicit",
      ...
      for (let t = 0; t < _.numberOfInputs; t += 1) {
        ...
        for (let e = 0; e < _.channelCount; e += 1)
          b[t].connect(A, e, t * _.channelCount + e);
      }
      const I = new At(
      ...
      A.connect(k);
      let E = _.channelInterpretation,
        R = null;
      const N = 0 === _.numberOfOutputs ? [k] : M,
        V = {
          get bufferSize() {
            return S;
          },
          ...
          set onprocessorerror(t) {
            ("function" == typeof R &&
              V.removeEventListener("processorerror", R),
              (R = "function" == typeof t ? t : null),
              "function" == typeof R &&
                V.addEventListener("processorerror", R));
          },
          get parameters() {
            return I;
          },
          ...
          connect: t.bind(null, N),
          disconnect: h.bind(null, N),
          dispatchEvent: (...t) => k.dispatchEvent(t[0]),
          removeEventListener: (...t) =>
            k.removeEventListener(t[0], t[1], t[2]),
        },
        P = new Map();
      var F, q;
      ((w.port1.addEventListener =
        ((F = w.port1.addEventListener),
        (...t) => {
          if ("message" === t[0]) {
            const e =
              "function" == typeof t[1]
      ...
      (Object.defineProperty(w.port1, "onmessage", {
        get: () => B,
        set: (t) => {
          ("function" == typeof B && w.port1.removeEventListener("message", B),
            (B = "function" == typeof t ? t : null),
            "function" == typeof B &&
              (w.port1.addEventListener("message", B), w.port1.start()));
        },
      }),
      ...
      j.then((t) => (W = t));
      const z = Mt(_.numberOfInputs, _.channelCount),
        L = Mt(_.numberOfOutputs, g),
        U =
          void 0 === m.parameterDescriptors
            ? []
        ...
        if (null !== W) {
          ...
          for (let s = 0; s < S; s += 128) {
            for (let e = 0; e < _.numberOfInputs; e += 1)
              for (let n = 0; n < _.channelCount; n += 1) kt(t, z[e], n, n, s);
            void 0 !== m.parameterDescriptors &&
            ...
            for (let t = 0; t < _.numberOfInputs; t += 1)
              for (let e = 0; e < g[t]; e += 1)
                0 === L[t][e].byteLength && (L[t][e] = new Float32Array(128));
            try {
              const t = z.map((t, e) => {
                  ...
                  return void 0 === s
                    ...
                    : (t.every((t) => t.every((t) => 0 === t)) &&
                        (1 === s ? Z.delete(e) : Z.set(e, s - 1)),
                      t);
                }),
                i = u(p.currentTime + s / p.sampleRate, p.sampleRate, () =>
                  W.process(t, L, U),
                );
              X = i;
            ...
            if (!X) {
              for (let t = 0; t < _.numberOfInputs; t += 1) {
                T[t].disconnect(b[t]);
                for (let e = 0; e < _.channelCount; e += 1)
                  b[s].disconnect(A, e, t * _.channelCount + e);
              }
              if (void 0 !== m.parameterDescriptors) {
      ...
      const $ = r(p, {
        ...
        J = () => k.connect($).connect(p.destination),
        K = () => {
    ...
    })(Os, Z, jt, wn, ne, kn, oe, ce, he, Ds, ps, Es, yn),
    Ns = ((t, e, n, s, i) => (o, r, a, c, h, u) => {
      if (null !== a)
        try {
          const e = new a(o, c, u),
            s = new Map();
    ...
    Vs = ((t, e, n, s, i, o, r, a, c, h, u, l, d, p, f, m) => (_, g, v) => {
      const y = new WeakMap();
      let x = null;
      return {
        render(w, T) {
            ...
            : (async (a, w) => {
                      ...
                      c = async () => {
                        ...
                        for (let t = 0; t < g.numberOfInputs; t += 1) {
                          ...
                          for (let e = 0; e < g.channelCount; e += 1)
                            u[t].connect(_, e, t * g.channelCount + e);
                        }
                        for (const [e, n] of l.entries())
                          (n.connect(_, 0, t + e), n.start(0));
                        return (
                          _.connect(c.destination),
                          await Promise.all(h.map((t) => f(a, c, t))),
                          m(c)
                        );
                      };
                    x = Dt(a, 0 === n ? null : await c(), w, g, A, v, h);
                  }
                  const t = await x,
                    e = n(w, {
                      buffer: null,
                ...
                if (C)
                  for (const [e, n] of a.parameters.entries())
                    await t(w, n, T.parameters.get(e));
                else
                  for (const [t, e] of a.parameters.entries())
                    await p(w, e, T.parameters.get(t));
                return (await f(a, w, T), T);
              })(w, T);
        },
      };
    })(cn, Os, hn, wn, ne, kn, oe, Ms, Ds, ps, mt, Ge, We, un, Pe, jn),
    Ps = (
      (t) => (e) =>
        t.get(e)
    )(fs),
                ...
                w =
                  g || "closed" !== _.state
                    ...
                    : null !== (m = r(_)) && void 0 !== m
                      ? m
                      : _,
                T = i(w, g ? null : e.baseLatency, h, p, x, v);
    ...
    Ws = (
      (t, e, n, s, i, o, r, a) => (c, h) =>
        n(c)
          .render(c, h)
          .then(() =>
            Promise.all(Array.from(s(h)).map((t) => n(t).render(t, h))),
          )
          .then(() => i(h))
          .then(
            (n) => (
    ...
    )(Je, De, Ve, Ss, jn, Y, nn, sn),
    js = ((t, e, n, s, i) =>
      class extends t {
        constructor(t, n, i) {
          let o;
          if ("number" == typeof t && void 0 !== n && void 0 !== i)
            o = { length: n, numberOfChannels: t, sampleRate: i };
          else {
            if ("object" != typeof t)
  ...
  const ri = "object" == typeof self ? self : null,
    ai =
      ri &&
      (ri.hasOwnProperty("AudioContext") ||
        ri.hasOwnProperty("webkitAudioContext"));
  function ci(t, e, n, s) {
    var i,
      o = arguments.length,
      r =
  ...
  class ui {
    constructor(t, e, n, s) {
      ((this._callback = t),
        (this._type = e),
        (this._minimumUpdateInterval = Math.max(128 / (s || 44100), 0.001)),
    ...
    if ($s(t) && $s(n))
      for (const e in n)
        mi(e, n[e])
          ? (t[e] = n[e])
          : $s(n[e])
            ? (t[e] || Object.assign(t, { [e]: {} }), _i(t[e], n[e]))
  ...
  function gi(t, e, n = [], s) {
    ...
    if ($s(o[0]) && s && !Reflect.has(o[0], s)) {
      Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
        (_i(i, { [s]: o[0] }), n.splice(n.indexOf(s), 1), o.shift());
    }
    if (1 === o.length && $s(o[0])) _i(i, o[0]);
    else for (let t = 0; t < n.length; t++) Zs(o[t]) && (i[n[t]] = o[t]);
    return _i(t, i);
  }
  function vi(t, e) {
    return Ys(t) ? e : t;
   ...
   */ class yi {
    ...
    log(...t) {
      (this.debug || (ri && this.toString() === ri.TONE_DEBUG_CLASS)) &&
        (function (...t) {
          ii.log(...t);
        })(this, ...t);
    }
  ...
  class Ei extends Ii {
    constructor() {
      ...
      (super(),
        ...
        (this._timeouts = new Ai()),
        (this._timeoutIds = 0),
        (this._initialized = !1),
        (this._closeStarted = !1),
        (this.isOffline = !1),
        (this._workletPromise = null));
      const n = gi(Ei.getDefaults(), arguments, ["context"]);
      (n.context
    ...
    initialize() {
      ...
      return (
        this._initialized ||
          ((t = this), Si.forEach((e) => e(t)), (this._initialized = !0)),
        this
      );
    }
    createAnalyser() {
    ...
    set draw(t) {
      (Js(!this._initialized, "Draw cannot be set after initialization."),
        (this._draw = t));
    }
    get destination() {
    ...
    createAudioWorkletNode(t, e) {
      return (function (t, e, n) {
        return (
          ...
          new (t instanceof (null == ri ? void 0 : ri.BaseAudioContext)
            ? null == ri
              ? void 0
              : ri.AudioWorkletNode
            : qs)(t, e, n)
    ...
    addAudioWorkletModule(t) {
      return hi(this, void 0, void 0, function* () {
        (Js(
          Zs(this.rawContext.audioWorklet),
    ...
    close() {
      return hi(this, void 0, void 0, function* () {
        ...
        (fi(this._context) &&
          ...
          this._initialized && ((t = this), Oi.forEach((e) => e(t))));
      });
    }
    getConstant(t) {
    ...
    setTimeout(t, e) {
      ...
      const n = this.now();
      return (
        this._timeouts.add({ callback: t, id: this._timeoutIds, time: n + e }),
        this._timeoutIds
      );
    }
    clearTimeout(t) {
  ...
  class Pi extends yi {
    constructor() {
      (super(), (this.name = "ToneAudioBuffer"), (this.onload = Vi));
    ...
    static getDefaults() {
      return { onerror: Vi, onload: Vi, reverse: !1 };
    }
    get sampleRate() {
    ...
    toMono(t) {
      if (Gs(t)) this.fromArray(this.toArray(t));
      else {
    ...
    slice(t, e = this.duration) {
      ...
      const i = s - n,
        o = Wi().createBuffer(this.numberOfChannels, i, this.sampleRate);
    ...
    static load(t) {
      return hi(this, void 0, void 0, function* () {
        ...
        const n =
            "" === Pi.baseUrl || Pi.baseUrl.endsWith("/")
              ? Pi.baseUrl
              : Pi.baseUrl + "/",
          s = document.createElement("a");
        ((s.href = n + t),
          (s.pathname = (s.pathname + s.hash)
            .split("/")
    ...
    static loaded() {
      return hi(this, void 0, void 0, function* () {
        for (yield Promise.resolve(); Pi.downloads.length; )
          yield Pi.downloads[0];
      });
    }
  }
  ...
  class Fi extends Ei {
    ...
    render() {
      return hi(this, arguments, void 0, function* (t = !0) {
  ...
  let Bi = qi;
  function Wi() {
    return (Bi === qi && ai && ji(new Ei()), Bi);
  }
  function ji(t, e = !1) {
    (e && Bi.dispose(), (Bi = fi(t) ? new Ei(t) : pi(t) ? new Fi(t) : t));
  }
  function zi() {
    return Bi.resume();
  }
  ...
  class $i extends yi {
    ...
    valueOf() {
      if ((this._val instanceof $i && this.fromType(this._val), Ys(this._val)))
        return this._noArg();
  ...
  class Hi extends $i {
    ...
    _getExpressions() {
      return Object.assign(super._getExpressions(), {
        ...
        quantize: {
          method: (t) => {
            const e = new Hi(this.context, t).valueOf();
    ...
    toNotation() {
      ...
      e.push("0");
      let n = e[0],
        s = new Hi(this.context, e[0]).toSeconds();
      return (
        e.forEach((e) => {
          const i = new Hi(this.context, e).toSeconds();
  ...
  class Qi extends Hi {
    ...
    _getExpressions() {
      return Object.assign({}, super._getExpressions(), {
        midi: {
          regexp: /^(\d+(?:\.\d+)?midi)/,
          method(t) {
            return "midi" === this.defaultUnits ? t : Qi.mtof(t);
          },
        },
        note: {
          regexp: /^([a-g]{1}(?:b|#|##|x|bb|###|#x|x#|bbb)?)(-?[0-9]+)/i,
          method(t, e) {
            const n = Ji[t.toLowerCase()] + 12 * (parseInt(e, 10) + 1);
            return "midi" === this.defaultUnits ? n : Qi.mtof(n);
          },
        },
        tr: {
          regexp: /^(\d+(?:\.\d+)?):(\d+(?:\.\d+)?):?(\d+(?:\.\d+)?)?/,
    ...
    transpose(t) {
      return new Qi(this.context, this.valueOf() * Yi(t));
    }
    harmonize(t) {
      return t.map((t) => this.transpose(t));
    }
    toMidi() {
      return Gi(this.valueOf());
    }
    toNote() {
  ...
  class eo extends yi {
    constructor() {
      super();
      const t = gi(eo.getDefaults(), arguments, ["context"]);
      this.defaultContext
    ...
    toSeconds(t) {
      return (
        ...
        new Hi(this.context, t).toSeconds()
      );
    }
    toFrequency(t) {
      return new Qi(this.context, t).toFrequency();
    }
    toTicks(t) {
      ...
      return (
        Object.keys(t).forEach((e) => {
          if (Reflect.has(this, e)) {
            const n = this[e];
            Zs(n) && Zs(n.value) && Zs(n.setValueAtTime)
              ? (t[e] = n.value)
              : n instanceof eo
                ? (t[e] = n._getPartialProperties(t[e]))
                : Hs(n) || Gs(n) || Qs(n) || "boolean" == typeof n
                  ? (t[e] = n)
                  : delete t[e];
          }
        }),
    ...
    set(t) {
      return (
        Object.keys(t).forEach((e) => {
          Reflect.has(this, e) &&
            Zs(this[e]) &&
            (this[e] && Zs(this[e].value) && Zs(this[e].setValueAtTime)
  ...
  class no extends eo {
    constructor() {
      const t = gi(no.getDefaults(), arguments, ["param", "units", "convert"]);
      for (
        super(t),
          this.name = "Param",
          this.overridden = !1,
          ...
          Js(
            Zs(t.param) && (li(t.param) || t.param instanceof no),
            "param must be an AudioParam",
          );
        !li(t.param);
      )
        t.param = t.param._param;
      ((this._swappable = !!Zs(t.swappable) && t.swappable),
        this._swappable
          ? ((this.input = this.context.createGain()),
            (this._param = t.param),
            this.input.connect(this._param))
          : (this._param = this.input = t.param),
        (this._events = new Ai(1e3)),
    ...
    _assertRange(t) {
      return (
        Zs(this.maxValue) &&
          Zs(this.minValue) &&
          Ks(t, this._fromType(this.minValue), this._fromType(this.maxValue)),
        t
      );
    }
    _fromType(t) {
    ...
    _toType(t) {
      return this.convert && "decibels" === this.units ? Xi(t) : t;
    }
    setValueAtTime(t, e) {
    ...
    getValueAtTime(t) {
      ...
      if (null === s) i = this._initialValue;
        ...
        ((n = null === t ? this._initialValue : t.value),
          "setTargetAtTime" === s.type &&
            (i = this._exponentialApproach(s.time, n, s.value, s.constant, e)));
      }
  ...
  class so extends eo {
    ...
    get numberOfInputs() {
      return Zs(this.input)
        ? li(this.input) || this.input instanceof no
          ? 1
    ...
    _isAudioNode(t) {
      return Zs(t) && (t instanceof so || di(t));
    }
    _getInternalNodes() {
    ...
    toMaster() {
      return (
        oi("toMaster() has been renamed toDestination()"),
        this.toDestination()
      );
    }
    disconnect(t, e = 0, n = 0) {
      return (ro(this, t, e, n), this);
    }
    chain(...t) {
      return (io(this, ...t), this);
    }
    fan(...t) {
    ...
    dispose() {
      return (
        super.dispose(),
        Zs(this.input) &&
          (this.input instanceof so
            ? this.input.dispose()
            : di(this.input) && this.input.disconnect()),
        Zs(this.output) &&
          (this.output instanceof so
            ? this.output.dispose()
            : di(this.output) && this.output.disconnect()),
  ...
  function io(...t) {
    const e = t.shift();
    t.reduce(
      (t, e) => (t instanceof so ? t.connect(e) : di(t) && oo(t, e), e),
      e,
    );
  }
  function oo(t, e, n = 0, s = 0) {
    for (
      Js(Zs(t), "Cannot connect from undefined node"),
        Js(Zs(e), "Cannot connect to undefined node"),
        (e instanceof so || di(e)) &&
          Js(e.numberOfInputs > 0, "Cannot connect to node with no inputs"),
        Js(t.numberOfOutputs > 0, "Cannot connect from node with no outputs");
      e instanceof so || e instanceof no;
    )
      Zs(e.input) && (e = e.input);
    for (; t instanceof so; ) Zs(t.output) && (t = t.output);
    li(e) ? t.connect(e, n) : t.connect(e, n, s);
  }
  function ro(t, e, n = 0, s = 0) {
    if (Zs(e)) for (; e instanceof so; ) e = e.input;
    for (; !di(t); ) Zs(t.output) && (t = t.output);
    li(e) ? t.disconnect(e, n) : di(e) ? t.disconnect(e, n, s) : t.disconnect();
  }
  class ao extends so {
    constructor() {
      const t = gi(ao.getDefaults(), arguments, ["gain", "units"]);
      (super(t),
        (this.name = "Gain"),
  ...
  class co extends so {
    constructor(t) {
      (super(t),
        ...
        (this._stopTime = -1),
        (this._timeout = -1),
        (this.output = new ao({ context: this.context, gain: 0 })),
    ...
    _stopGain(t) {
      (Js(-1 !== this._startTime, "'start' must be called before 'stop'"),
        this.cancelStop());
    ...
    _onended() {
      if (
        this.onended !== Vi &&
        (this.onended(this), (this.onended = Vi), !this.context.isOffline)
      ) {
    ...
    cancelStop() {
      return (
        this.log("cancelStop"),
        Js(-1 !== this._startTime, "Source is not started"),
  ...
  class ho extends co {
    constructor() {
      const t = gi(ho.getDefaults(), arguments, ["offset"]);
      (super(t),
        (this.name = "ToneConstantSource"),
        (this._source = this.context.createConstantSource()),
        oo(this._source, this._gainNode),
        (this.offset = new no({
          context: this.context,
          convert: t.convert,
  ...
  class uo extends so {
    constructor() {
      const t = gi(uo.getDefaults(), arguments, ["value", "units"]);
      (super(t),
        (this.name = "Signal"),
        (this.override = !0),
  ...
  function lo(t, e, n, s) {
    ((e instanceof no || li(e) || (e instanceof uo && e.override)) &&
      (e.cancelScheduledValues(0),
      e.setValueAtTime(0, 0),
      e instanceof uo && (e.overridden = !0)),
      oo(t, e, n, s));
  }
  class po extends so {
    constructor() {
      const t = gi(po.getDefaults(), arguments, ["volume"]);
      (super(t),
        (this.name = "Volume"),
        (this.input = this.output =
          new ao({ context: this.context, gain: t.volume, units: "decibels" })),
    ...
    static getDefaults() {
      return Object.assign(so.getDefaults(), { mute: !1, volume: 0 });
    }
    get mute() {
  ...
  class fo extends so {
    constructor() {
      const t = gi(fo.getDefaults(), arguments);
      (super(t),
        (this.name = "Destination"),
        (this.input = new po({ context: this.context })),
        (this.output = new ao({ context: this.context })),
        (this.volume = this.input.volume),
        io(this.input, this.output, this.context.rawContext.destination),
        (this.mute = t.mute),
        (this._internalChannels = [
          this.input,
  ...
  (ki((t) => {
    t.destination = new fo({ context: t });
  }),
    Mi((t) => {
  ...
  class mo extends yi {
    constructor(t) {
      (super(),
        ...
        (this._timeline = new Ai({ memory: 10 })),
  ...
  class _o extends so {
    constructor() {
      super(gi(_o.getDefaults(), arguments, ["context"]));
    }
    connect(t, e = 0, n = 0) {
      return (lo(this, t, e, n), this);
    }
  ...
  class go extends _o {
    constructor() {
      const t = gi(go.getDefaults(), arguments, ["mapping", "length"]);
      (super(t),
        (this.name = "WaveShaper"),
        (this._shaper = this.context.createWaveShaper()),
        (this.input = this._shaper),
        (this.output = this._shaper),
        Hs(t.mapping) || t.mapping instanceof Float32Array
          ? (this.curve = Float32Array.from(t.mapping))
          : "function" == typeof t.mapping && this.setMap(t.mapping, t.length));
    }
    static getDefaults() {
      return Object.assign(uo.getDefaults(), { length: 1024 });
    }
    setMap(t, e = 1024) {
  ...
  class vo extends _o {
    constructor() {
      const t = gi(vo.getDefaults(), arguments, ["value"]);
      (super(t),
        (this.name = "Pow"),
    ...
    static getDefaults() {
      return Object.assign(_o.getDefaults(), { value: 1 });
    }
    _expFunc(t) {
  ...
  class xo extends yi {
    ...
    add(t) {
      (Js(Zs(t.time), "Events must have a time property"),
        Js(Zs(t.duration), "Events must have a duration parameter"),
        (t.time = t.time.valueOf()));
  ...
  class bo extends no {
    constructor() {
      const t = gi(bo.getDefaults(), arguments, ["value"]);
      (super(t),
        (this.name = "TickParam"),
        (this._events = new Ai(1 / 0)),
        (this._multiplier = 1),
  ...
  class Co extends uo {
    constructor() {
      const t = gi(Co.getDefaults(), arguments, ["value"]);
      (super(t),
  ...
  class Ao extends eo {
    constructor() {
      const t = gi(Ao.getDefaults(), arguments, ["frequency"]);
      (super(t),
        (this.name = "TickSource"),
        (this._state = new To()),
        (this._tickOffset = new Ai()),
        (this._ticksAtTime = new Ai()),
        (this._secondsAtTime = new Ai()),
        (this.frequency = new Co({
          context: this.context,
          units: t.units,
          value: t.frequency,
        })),
    ...
    getTicksAtTime(t) {
      ...
      return (
        this._state.forEachBetween(o.time, e + this.sampleTime, (t) => {
          ...
          (n && n.time >= o.time && ((r = n.ticks), (e = n.time)),
            "started" === o.state &&
              "started" !== t.state &&
              ((r +=
    ...
    getSecondsAtTime(t) {
      ...
      return (
        this._state.forEachBetween(i.time, t + this.sampleTime, (t) => {
          ...
          (s && s.time >= i.time && ((o = s.seconds), (e = s.time)),
            "started" === i.state &&
              "started" !== t.state &&
              ((o += t.time - e),
              t.time !== n.time &&
  ...
  class So extends eo {
    constructor() {
      const t = gi(So.getDefaults(), arguments, ["callback", "frequency"]);
      (super(t),
        (this.name = "Clock"),
        (this.callback = Vi),
        (this._lastUpdate = 0),
        (this._state = new To("stopped")),
        (this._boundLoop = this._loop.bind(this)),
        (this.callback = t.callback),
        (this._tickSource = new Ao({
          context: this.context,
  ...
  class ko {
    constructor(t, e) {
      ((this.id = ko._eventId++), (this._remainderTime = 0));
      const n = Object.assign(ko.getDefaults(), e);
      ((this.transport = t),
        (this.callback = n.callback),
        (this._once = n.once),
        (this.time = Math.floor(n.time)),
        (this._remainderTime = n.time - this.time));
    }
    static getDefaults() {
      return { callback: Vi, once: !1, time: 0 };
    }
    get floatTime() {
  ...
  class Oo extends ko {
    constructor(t, e) {
      ...
      const n = Object.assign(Oo.getDefaults(), e);
      ((this.duration = n.duration),
        (this._interval = n.interval),
    ...
    _createEvent() {
      return bi(this._nextTick, this.floatTime + this.duration)
        ? this.transport.scheduleOnce(
            this.invoke.bind(this),
            new yo(this.context, this._nextTick).toSeconds(),
          )
        : -1;
    }
    _createEvents(t) {
      bi(this._nextTick + this._interval, this.floatTime + this.duration) &&
  ...
  class Mo extends eo {
    constructor() {
      const t = gi(Mo.getDefaults(), arguments);
      (super(t),
        (this.name = "Transport"),
        (this._loop = new mo(!1)),
        (this._loopStart = 0),
        ...
        (this._timeline = new Ai()),
        (this._repeatedEvents = new xo()),
        (this._syncedSignals = []),
        (this._swingAmount = 0),
        (this._ppq = t.ppq),
        (this._clock = new So({
    ...
    _processTick(t, e) {
      if (
        ...
        t += new yo(this.context, (2 * this._swingTicks) / 3).toSeconds() * s;
      }
    ...
    scheduleRepeat(t, e, n, s = 1 / 0) {
      const i = new Oo(this, {
        callback: t,
        duration: new Hi(this.context, s).toTicks(),
        interval: new Hi(this.context, e).toTicks(),
        time: new to(this.context, n).toTicks(),
      });
    ...
    _bindClockEvents() {
      (this._clock.on("start", (t, e) => {
        ((e = new yo(this.context, e).toSeconds()), this.emit("start", t, e));
      }),
    ...
    get loopStart() {
      return new Hi(this.context, this._loopStart, "i").toSeconds();
    }
    set loopStart(t) {
      this._loopStart = this.toTicks(t);
    }
    get loopEnd() {
      return new Hi(this.context, this._loopEnd, "i").toSeconds();
    }
    set loopEnd(t) {
    ...
    get swingSubdivision() {
      return new yo(this.context, this._swingTicks).toNotation();
    }
    ...
    get position() {
      ...
      return new yo(this.context, e).toBarsBeatsSixteenths();
    }
    set position(t) {
      const e = this.toTicks(t);
      this.ticks = e;
      ...
      if (this._clock.ticks !== t) {
        ...
        if ("started" === this.state) {
          const n = this._clock.getTicksAtTime(e),
            s =
              e + this._clock.frequency.getDurationOfTicks(Math.ceil(n) - n, e);
          (this.emit("stop", s),
    ...
    syncSignal(t, e) {
      const n = this.now();
      let s = this.bpm,
        i = 1 / (60 / s.getValueAtTime(n) / this.PPQ),
        o = [];
      if ("time" === t.units) {
        const t = 1 / 64 / i,
          e = new ao(t),
  ...
  class Do extends so {
    constructor(t) {
      (super(t),
        ...
        (this._synced = !1),
        (this._scheduled = []),
        (this._syncedStart = Vi),
        (this._syncedStop = Vi),
        (this._state.memory = 100),
        (this._state.increasing = !0),
        (this._volume = this.output =
          new po({ context: this.context, mute: t.mute, volume: t.volume })),
    ...
    start(t, e, n) {
      ...
      if (
        ...
        if (
          ...
          t &&
            ((t.offset = this.toSeconds(vi(e, 0))),
        ...
        } else (ti(this.context), this._start(s, e, n));
      else
        (Js(
          wi(s, this._state.get(s).time),
    ...
    stop(t) {
      ...
      if (
        ...
        "started" === this._state.getValueAtTime(e) ||
          Zs(this._state.getNextState("started", e)))
      ) {
  ...
  class Io extends co {
    constructor() {
      const t = gi(Io.getDefaults(), arguments, ["frequency", "type"]);
      (super(t),
        (this.name = "ToneOscillatorNode"),
        (this._oscillator = this.context.createOscillator()),
        (this._internalChannels = [this._oscillator]),
        oo(this._oscillator, this._gainNode),
        (this.type = t.type),
  ...
  class Eo extends Do {
    constructor() {
      const t = gi(Eo.getDefaults(), arguments, ["frequency", "type"]);
      (super(t),
        (this.name = "Oscillator"),
        (this._oscillator = null),
        (this.frequency = new uo({
          context: this.context,
          units: "frequency",
          value: t.frequency,
        })),
    ...
    _start(t) {
      const e = this.toSeconds(t),
        n = new Io({ context: this.context, onended: () => this.onstop(this) });
      ((this._oscillator = n),
        this._wave
    ...
    _getCachedPeriodicWave() {
      if ("custom" === this._type) {
        return Eo._periodicWaveCache.find((t) => {
          return (
            t.phase === this._phase &&
            ((e = t.partials),
            (n = this._partials),
      ...
      {
        const t = Eo._periodicWaveCache.find(
      ...
      if (0 === this._phase && e)
        ...
        if (Zs(e)) {
          ...
          ((this._wave = s),
            ...
            Eo._periodicWaveCache.length > 100 &&
              Eo._periodicWaveCache.shift());
        }
      }
    }
    get baseType() {
    ...
    getInitialValue() {
      ...
      return (
        (i = -this._inverseFFT(t, e, this._phase) / n),
        (o = -1),
        (r = 1),
        Math.max(Math.min(i, r), o)
      );
      var i, o, r;
    }
    get partials() {
    ...
    asArray() {
      return hi(this, arguments, void 0, function* (t = 1024) {
        return (function (t, e) {
          return hi(this, void 0, void 0, function* () {
            const n = e / t.context.sampleRate,
              s = new Fi(1, n, t.context.sampleRate);
            return (
              new t.constructor(
                Object.assign(t.get(), {
                  frequency: 2 / n,
  ...
  class Ro {
    constructor(t = 440, e = "sine") {
      ...
      ((this.frequency = t),
        (this.type = e),
        (this.osc = new Eo().toDestination()),
        (this.osc.frequency.value = this.frequency),
        (this.osc.type = this.type),
        (this.osc.volume.value = -6));
    }
    freq(t, e = 0) {
      this.osc.frequency.rampTo(Li(t, 0, 24e3), e);
    }
    phase(t) {
      this.osc.phase = t;
    }
    ...
    amp(t, e = 0.1) {
      if ("object" == typeof t)
        return void t.getNode().connect(this.osc.volume);
      let n = Xi(t);
      this.osc.volume.rampTo(n, e);
    }
    start() {
      this.osc.start();
    }
    ...
    connect(t) {
      "function" == typeof t.getNode
        ? this.osc.connect(t.getNode())
        : this.osc.connect(t);
    }
    disconnect() {
      this.osc.disconnect(Ei.destination);
    }
    getNode() {
      return this.osc;
    }
  ...
  class Po extends so {
    constructor() {
      const t = gi(Po.getDefaults(), arguments, [
        "attack",
        "decay",
        "sustain",
        "release",
      ...
      (super(t),
        (this.name = "Envelope"),
        (this._sig = new uo({ context: this.context, value: 0 })),
    ...
    _getCurve(t, e) {
      ...
      {
        let n;
        for (n in Fo) if (Fo[n][e] === t) return n;
        return t;
      }
    }
    _setCurve(t, e, n) {
      if (Qs(n) && Reflect.has(Fo, n)) {
        const s = Fo[n];
        $s(s) ? "_decayCurve" !== t && (this[t] = s[e]) : (this[t] = s);
      } else {
        if (!Hs(n) || "_decayCurve" === t)
    ...
    asArray() {
      return hi(this, arguments, void 0, function* (t = 1024) {
        const e = t / this.context.sampleRate,
          n = new Fi(1, e, this.context.sampleRate),
  ...
  (ci([Vo(0)], Po.prototype, "attack", void 0),
    ci([Vo(0)], Po.prototype, "decay", void 0),
    ci(
      [
        (function (t, e = 1 / 0) {
          const n = new WeakMap();
    ...
    ci([Vo(0)], Po.prototype, "release", void 0));
  const Fo = (() => {
    const t = 128;
    let e, n;
    const s = [];
    ...
    const r = [];
    for (e = 0; e < t; e++)
      ((n = e / 127), (r[e] = 0.5 * (1 - Math.cos(Math.PI * n))));
    const a = [];
    for (e = 0; e < t; e++) {
      n = e / 127;
      const t = 4 * Math.pow(n, 3) + 0.2,
        s = Math.cos(t * Math.PI * 2 * n);
      a[e] = Math.abs(s * (1 - n));
    }
    function c(t) {
    ...
    return {
      bounce: { In: c(a), Out: a },
      cosine: { In: s, Out: ((h = s), h.slice(0).reverse()) },
  ...
  class qo extends Po {
    constructor() {
      (super(
        ...
        (this._gainNode = new ao({ context: this.context, gain: 0 })),
        (this.output = this._gainNode),
        (this.input = this._gainNode),
  ...
  var Bo = class {
    constructor(t = 0.1, e = 0.12, n = 0.1, s = 0.2) {
      ((this.attack = t),
        (this.attackLevel = 1),
        (this.decay = e),
        (this.sustain = n),
        (this.release = s),
        (this.envelope = new qo({
          attack: this.attack,
          decay: this.decay,
    ...
    setInput(t) {
      t.getNode().connect(this.envelope);
    }
    setADSR(t, e, n, s) {
      ((this.envelope.attack = t),
        (this.envelope.decay = e),
        (this.envelope.sustain = n),
        (this.envelope.release = s));
    }
    releaseTime(t) {
      this.envelope.release = t;
    }
    attackTime(t) {
      this.envelope.attack = t;
    }
    connect(t) {
      this.envelope.connect(t.getNode());
    }
    disconnect() {
      this.envelope.disconnect(Ei.destination);
    }
    getNode() {
  ...
  class Wo extends so {
    constructor() {
      const t = gi(Wo.getDefaults(), arguments, ["delayTime", "maxDelay"]);
    ...
    static getDefaults() {
      return Object.assign(so.getDefaults(), { delayTime: 0, maxDelay: 1 });
    }
    get maxDelay() {
  ...
  class zo extends so {
    constructor() {
      const t = gi(zo.getDefaults(), arguments, ["fade"]);
      (super(t),
        (this.name = "CrossFade"),
        (this._panner = this.context.createStereoPanner()),
        (this._split = this.context.createChannelSplitter(2)),
        (this._g2a = new jo({ context: this.context })),
        (this.a = new ao({ context: this.context, gain: 0 })),
        (this.b = new ao({ context: this.context, gain: 0 })),
        (this.output = new ao({ context: this.context })),
        ...
        oo(this._split, this.a.gain, 0),
        oo(this._split, this.b.gain, 1),
        this.fade.chain(this._g2a, this._panner.pan),
        this.a.connect(this.output),
        this.b.connect(this.output));
    }
    static getDefaults() {
      return Object.assign(so.getDefaults(), { fade: 0.5 });
    }
    dispose() {
      return (
        super.dispose(),
  ...
  class Lo extends so {
    constructor(t) {
      (super(t),
        (this.name = "Effect"),
        (this._dryWet = new zo({ context: this.context })),
        (this.wet = this._dryWet.fade),
        (this.effectSend = new ao({ context: this.context })),
        (this.effectReturn = new ao({ context: this.context })),
        (this.input = new ao({ context: this.context })),
    ...
    static getDefaults() {
      return Object.assign(so.getDefaults(), { wet: 1 });
    }
    connectEffect(t) {
      return (
  ...
  class Uo extends Lo {
    ...
    static getDefaults() {
      return Object.assign(Lo.getDefaults(), { feedback: 0.125 });
    }
    dispose() {
      return (
        super.dispose(),
  ...
  class Xo extends Uo {
    constructor() {
      const t = gi(Xo.getDefaults(), arguments, ["delayTime", "feedback"]);
      (super(t),
        (this.name = "FeedbackDelay"),
        (this._delayNode = new Wo({
          context: this.context,
    ...
    static getDefaults() {
      return Object.assign(Uo.getDefaults(), { delayTime: 0.25, maxDelay: 1 });
    }
    dispose() {
      return (
        super.dispose(),
  ...
  var Yo = class {
    constructor(t = 0.25, e = 0.2) {
      ((this.d = t),
        (this.f = e),
        (this.delay = new Xo(this.d, this.f).toDestination()));
    }
    delayTime(t, e = 0.1) {
      0 != e
        ? this.delay.delayTime.rampTo(Li(t, 0, 1), e)
        : (this.delay.delayTime.value = Li(t, 0, 1));
    }
    feedback(t) {
      this.delay.feedback.rampTo(Li(t, 0, 0.99), 0.1);
    }
    process(t, e, n) {
      ((this.delay.delayTime.value = e),
        (this.delay.feedback.value = n),
        t.getNode().connect(this.delay));
    }
    amp(t) {
      let e = Xi(t);
      this.delay.volume.rampTo(e, 0.1);
    }
    getNode() {
      return this.delay;
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.delay.connect(t.getNode())
        : this.delay.connect(t);
    }
    disconnect() {
      this.delay.disconnect(Ei.destination);
    }
  };
  class Zo extends so {
    constructor() {
      const t = gi(Zo.getDefaults(), arguments, ["channels"]);
      (super(t),
        (this.name = "Merge"),
        (this._merger =
          this.output =
    ...
    static getDefaults() {
      return Object.assign(so.getDefaults(), { channels: 2 });
    }
    dispose() {
  ...
  class Go extends co {
    constructor() {
      const t = gi(Go.getDefaults(), arguments, ["url", "onload"]);
      (super(t),
        ...
        (this._buffer = new Pi(t.url, t.onload, t.onerror)),
    ...
    start(t, e, n, s = 1) {
      ...
      (this._startGain(i, s),
        (e = this.loop ? vi(e, this.loopStart) : vi(e, 0)));
  ...
  class $o extends Do {
    constructor() {
      const t = gi($o.getDefaults(), arguments, ["type"]);
      (super(t),
        (this.name = "Noise"),
        (this._source = null),
    ...
    set type(t) {
      if (
        (Js(t in Jo, "Noise: invalid type: " + t),
  ...
  const Ho = 220500,
    Qo = { brown: null, pink: null, white: null },
    Jo = {
      get brown() {
        if (!Qo.brown) {
          const t = [];
          for (let e = 0; e < 2; e++) {
            const n = new Float32Array(Ho);
            t[e] = n;
            let s = 0;
            for (let t = 0; t < Ho; t++) {
          ...
          for (let e = 0; e < 2; e++) {
            ...
            for (let t = 0; t < Ho; t++) {
              ...
              ((s = 0.99886 * s + 0.0555179 * e),
                ...
                (n[t] = s + i + o + r + a + c + h + 0.5362 * e),
                (n[t] *= 0.11),
                (h = 0.115926 * e));
            }
          }
          Qo.pink = new Pi().fromArray(t);
        }
        return Qo.pink;
      },
      get white() {
        if (!Qo.white) {
          ...
          for (let e = 0; e < 2; e++) {
            const n = new Float32Array(Ho);
            t[e] = n;
            for (let t = 0; t < Ho; t++) n[t] = 2 * Math.random() - 1;
          }
          Qo.white = new Pi().fromArray(t);
        }
        return Qo.white;
      },
    };
  class Ko extends Lo {
    constructor() {
      const t = gi(Ko.getDefaults(), arguments, ["decay"]);
      (super(t),
        (this.name = "Reverb"),
    ...
    static getDefaults() {
      return Object.assign(Lo.getDefaults(), { decay: 1.5, preDelay: 0.01 });
    }
    get decay() {
      return this._decay;
    }
    set decay(t) {
      (Ks((t = this.toSeconds(t)), 0.001), (this._decay = t), this.generate());
    }
    get preDelay() {
    ...
    generate() {
      return hi(this, void 0, void 0, function* () {
        const t = this.ready,
          e = new Fi(2, this._decay + this._preDelay, this.context.sampleRate),
          n = new $o({ context: e }),
          s = new $o({ context: e }),
          i = new Zo({ context: e });
        (n.connect(i, 0, 0), s.connect(i, 0, 1));
        const o = new ao({ context: e }).toDestination();
        (i.connect(o),
          n.start(0),
          s.start(0),
  ...
  var tr = class {
    constructor(t) {
      ((this.decayTime = t || 1),
        (this.reverb = new Ko(this.decayTime).toDestination()));
    }
    set(t) {
      this.reverb.decay = t;
    }
    ...
    connect(t) {
      "function" == typeof t.getNode
        ? this.reverb.connect(t.getNode())
        : this.reverb.connect(t);
    }
    disconnect() {
      this.reverb.disconnect(Ei.destination);
    }
    getNode() {
      return this.reverb;
    }
  ...
  class er extends so {
    constructor() {
      const t = gi(er.getDefaults(), arguments, ["frequency", "type"]);
      (super(t),
  ...
  class nr {
    constructor(t = 800, e = "lowpass") {
      ((this.type = e),
        (this.cutoff = t),
        (this.biquad = new er(this.cutoff, this.type).toDestination()));
    }
    res(t) {
    ...
    freq(t) {
      this.biquad.frequency.value = Li(t, 0, 24e3);
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.biquad.connect(t.getNode())
        : this.biquad.connect(t);
    }
    disconnect() {
      this.biquad.disconnect(Ei.destination);
    }
    getNode() {
      return this.biquad;
    }
  ...
  class or extends uo {
    constructor() {
      (super(gi(or.getDefaults(), arguments, ["value"])),
        (this.override = !1),
        (this.name = "Add"),
        (this._sum = new ao({ context: this.context })),
        (this.input = this._sum),
        (this.output = this._sum),
        (this.addend = this._param),
        io(this._constantSource, this._sum));
    }
    static getDefaults() {
      return Object.assign(uo.getDefaults(), { value: 0 });
    }
    dispose() {
  ...
  class rr extends uo {
    constructor() {
      const t = gi(rr.getDefaults(), arguments, ["value"]);
      (super(t),
        (this.name = "Multiply"),
        (this.override = !1),
        (this._mult =
  ...
  class ar extends _o {
    constructor() {
      const t = gi(ar.getDefaults(), arguments, ["min", "max"]);
      (super(t),
        (this.name = "Scale"),
        (this._mult = this.input =
          new rr({ context: this.context, value: t.max - t.min })),
        (this._add = this.output =
          new or({ context: this.context, value: t.min })),
        (this._min = t.min),
        (this._max = t.max),
        this.input.connect(this.output));
    }
    static getDefaults() {
      return Object.assign(_o.getDefaults(), { max: 1, min: 0 });
    }
    get min() {
      return this._min;
    }
  ...
  class cr extends _o {
    constructor() {
      (super(gi(cr.getDefaults(), arguments)),
        (this.name = "Zero"),
        (this._gain = new ao({ context: this.context })),
        (this.output = this._gain),
        (this.input = void 0),
        oo(this.context.getConstant(0), this._gain));
    }
    dispose() {
      return (
        super.dispose(),
  ...
  class hr extends so {
    constructor() {
      const t = gi(hr.getDefaults(), arguments, ["frequency", "min", "max"]);
      (super(t),
        (this.name = "LFO"),
        ...
        (this._oscillator = new Eo(t)),
        (this.frequency = this._oscillator.frequency),
        (this._amplitudeGain = new ao({
          context: this.context,
          gain: t.amplitude,
          units: "normalRange",
        })),
        (this.amplitude = this._amplitudeGain.gain),
        (this._stoppedSignal = new uo({
          context: this.context,
          units: "audioRange",
          value: 0,
        })),
        (this._zeros = new cr({ context: this.context })),
        (this._a2g = new ir({ context: this.context })),
        (this._scaler = this.output =
          new ar({ context: this.context, max: t.max, min: t.min })),
        (this.units = t.units),
        (this.min = t.min),
        (this.max = t.max),
    ...
    connect(t, e, n) {
      return (
        (t instanceof no || t instanceof uo) &&
  ...
  class ur extends Uo {
    constructor() {
      const t = gi(ur.getDefaults(), arguments, ["pitch"]);
      (super(t),
        (this.name = "PitchShift"),
        (this._frequency = new uo({ context: this.context })),
        (this._delayA = new Wo({ maxDelay: 1, context: this.context })),
        (this._lfoA = new hr({
          context: this.context,
          min: 0,
          max: 0.1,
        ...
        (this._delayB = new Wo({ maxDelay: 1, context: this.context })),
        (this._lfoB = new hr({
          context: this.context,
          min: 0,
          max: 0.1,
        ...
        (this._crossFade = new zo({ context: this.context })),
        (this._crossFadeLFO = new hr({
          context: this.context,
          min: 0,
          max: 1,
          type: "triangle",
  ...
  var lr = class {
    constructor(t = 1) {
      this.pitchshifter = new ur(t).toDestination();
    }
    shift(t) {
      void 0 !== t && (this.pitchshifter.pitch = t);
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.pitchshifter.connect(t.getNode())
        : this.pitchshifter.connect(t);
    }
    disconnect() {
      this.pitchshifter.disconnect(Ei.destination);
    }
    getNode() {
  ...
  var dr = class {
    constructor(t = 1) {
      this.gain = new ao(t).toDestination();
    }
    amp(t) {
      "object" != typeof t
        ? this.gain.gain.rampTo(t, 0.1)
        : t.getNode().connect(this.gain.gain);
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.gain.connect(t.getNode())
        : this.gain.connect(t);
    }
    disconnect() {
      this.gain.disconnect(Ei.destination);
    }
    getNode() {
      return this.gain;
    }
  ...
  class pr extends so {
    constructor() {
      const t = gi(pr.getDefaults(), arguments, ["channels"]);
      (super(t),
        (this.name = "Split"),
        (this._splitter =
          this.input =
  ...
  class fr extends so {
    constructor() {
      const t = gi(fr.getDefaults(), arguments, ["type", "size"]);
      (super(t),
        (this.name = "Analyser"),
        (this._analysers = []),
        (this._buffers = []),
        (this.input =
          this.output =
          this._gain =
            new ao({ context: this.context })),
        (this._split = new pr({ context: this.context, channels: t.channels })),
    ...
    set type(t) {
      (Js("waveform" === t || "fft" === t, `Analyser: invalid type: ${t}`),
        (this._type = t));
    }
    get smoothing() {
  ...
  class mr extends so {
    constructor() {
      (super(gi(mr.getDefaults(), arguments)),
        (this.name = "MeterBase"),
        (this.input =
          this.output =
          this._analyser =
            new fr({ context: this.context, size: 256, type: "waveform" })));
    }
    dispose() {
  ...
  class _r extends mr {
    constructor() {
      const t = gi(_r.getDefaults(), arguments, ["smoothing"]);
      (super(t),
        (this.name = "Meter"),
        (this.input =
          this.output =
    ...
    getValue() {
      const t = this._analyser.getValue(),
        e = (1 === this.channels ? [t] : t).map((t, e) => {
          const n = t.reduce((t, e) => t + e * e, 0),
            s = Math.sqrt(n / t.length);
          return (
            (this._rms[e] = Math.max(s, this._rms[e] * this.smoothing)),
            this.normalRange ? this._rms[e] : Xi(this._rms[e])
          );
        });
  ...
  var gr = class {
    constructor(t = 0) {
      this.amplitude = new _r({ normalRange: !0, smoothing: t });
    }
    setInput(t) {
      t.getNode().connect(this.amplitude);
    }
    getLevel() {
      return this.amplitude.getValue();
    }
    smooth(t) {
      this.amplitude.smoothing = t;
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.amplitude.connect(t.getNode())
        : this.amplitude.connect(t);
    }
    disconnect() {
      this.amplitude.disconnect(Ei.destination);
    }
    getNode() {
  ...
  class vr extends mr {
    constructor() {
      const t = gi(vr.getDefaults(), arguments, ["size"]);
      (super(t),
        (this.name = "FFT"),
        (this.normalRange = t.normalRange),
  ...
  class yr extends mr {
    constructor() {
      const t = gi(yr.getDefaults(), arguments, ["size"]);
      (super(t),
        (this.name = "Waveform"),
    ...
    static getDefaults() {
      return Object.assign(mr.getDefaults(), { size: 1024 });
    }
    getValue() {
  ...
  var xr = class {
    constructor(t = 32) {
      ((this.fftSize = t),
        (this.analyzer = new vr({ size: this.fftSize, normalRange: !0 })),
        (this.samples = new yr()),
        (this.gain = new ao(1)),
  ...
  var wr = class {
    constructor(t) {
      (void 0 === t && (t = "white"),
        (this.noise = new $o().toDestination()),
        (this.noise.type = t));
    }
    type(t) {
      this.noise.type = t;
    ...
    amp(t, e = 0.1) {
      if ("object" == typeof t)
        return void t.getNode().connect(this.noise.volume);
      let n = Xi(t);
      this.noise.volume.rampTo(n, e);
    }
    start() {
      this.noise.start();
    }
    ...
    connect(t) {
      "function" == typeof t.getNode
        ? this.noise.connect(t.getNode())
        : this.noise.connect(t);
    }
    disconnect() {
      this.noise.disconnect(Ei.destination);
    }
    getNode() {
      return this.noise;
    }
  ...
  class Tr extends so {
    constructor() {
      const t = gi(Tr.getDefaults(), arguments, ["pan"]);
      (super(t),
        (this.name = "Panner"),
        (this._panner = this.context.createStereoPanner()),
    ...
    static getDefaults() {
      return Object.assign(so.getDefaults(), { pan: 0, channelCount: 1 });
    }
    dispose() {
      return (
        super.dispose(),
  ...
  var br = class {
    constructor() {
      this.panner = new Tr(0).toDestination();
    }
    pan(t) {
      "object" != typeof t
        ? this.panner.pan.rampTo(Li(t, -1, 1), 0.01)
        : t.getNode().connect(this.panner.pan);
    }
    getNode() {
      return this.panner;
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.panner.connect(t.getNode())
        : this.panner.connect(t);
    }
    disconnect() {
      this.panner.disconnect(Ei.destination);
    }
  };
  class Cr extends so {
    constructor() {
  ...
  class Ar extends so {
    constructor() {
      const t = gi(Ar.getDefaults(), arguments, [
        "positionX",
        "positionY",
        "positionZ",
      ]);
  ...
  var Sr = class {
    ...
    process(t) {
      t.getNode().connect(this.panner3d);
    }
    set(t, e, n) {
      (this.panner3d.positionX.rampTo(t, 0.01),
        this.panner3d.positionY.rampTo(e, 0.01),
        this.panner3d.positionZ.rampTo(n, 0.01));
    }
    setFalloff(t, e) {
      ((this.panner3d.rolloffFactor = t), (this.panner3d.maxDistance = e));
    }
    maxDist(t) {
      this.panner3d.maxDistance = t;
    }
    rolloff(t) {
      this.panner3d.rolloffFactor = t;
    }
    positionX(t) {
      this.panner3d.positionX.rampTo(t, 0.01);
    }
    positionY(t) {
      this.panner3d.positionY.rampTo(t, 0.01);
    }
    positionZ(t) {
      this.panner3d.positionZ.rampTo(t, 0.01);
    }
    connect(t) {
      "function" == typeof t.getNode
        ? this.panner3d.connect(t.getNode())
        : this.panner3d.connect(t);
    }
    disconnect() {
      this.panner3d.disconnect(Ei.destination);
    }
    getNode() {
  ...
  class kr extends Do {
    constructor() {
      const t = gi(kr.getDefaults(), arguments, ["url", "onload"]);
      (super(t),
        (this.name = "Player"),
    ...
    _restart(t, e, n) {
      var s;
      (null === (s = [...this._activeSources].pop()) ||
        void 0 === s ||
        s.stop(t),
        this._start(t, e, n));
    }
    ...
    set loopStart(t) {
      ((this._loopStart = t),
        this.buffer.loaded && Ks(this.toSeconds(t), 0, this.buffer.duration),
  ...
  (ci([Vo(0)], kr.prototype, "fadeIn", void 0),
    ci([Vo(0)], kr.prototype, "fadeOut", void 0));
  var Or = class {
    constructor(t, e) {
      ((this.soundfile = new kr(t, e).toDestination()),
        (this.playing = !1),
        (this.speed = 1),
        (this.paused = !1));
    }
    start() {
      ((this.soundfile.playbackRate = this.speed),
        (this.playing = !0),
        this.paused || this.soundfile.start());
    }
    play() {
      ((this.soundfile.playbackRate = this.speed),
        (this.playing = !0),
    ...
    loop(t = !0) {
      this.soundfile.loop = t;
    }
    loopPoints(t = 0, e = this.soundfile.buffer.duration, n = 0) {
      ((this.soundfile.loopStart = t), (this.soundfile.loopEnd = t + e));
    }
    amp(t) {
      let e = Xi(t);
      this.soundfile.volume.value = e;
    }
    setPath(t, e) {
      this.soundfile
        .load(t)
    ...
    rate(t = 1) {
      (t < 0 && (t = 0), (this.soundfile.playbackRate = t), (this.speed = t));
    }
    duration() {
    ...
    connect(t) {
      this.soundfile.connect(t.getNode());
    }
    disconnect() {
      this.soundfile.disconnect(Ei.destination);
    }
    getNode() {
  ...
  class Mr extends so {
    constructor() {
      const t = gi(Mr.getDefaults(), arguments, ["volume"]);
      (super(t),
        (this.name = "UserMedia"),
        (this._volume = this.output =
          new po({ context: this.context, volume: t.volume })),
        (this.volume = this._volume.volume),
        Ri(this, "volume"),
        (this.mute = t.mute));
    }
    ...
    open(t) {
      return hi(this, void 0, void 0, function* () {
        (Js(Mr.supported, "UserMedia is not supported"),
          "started" === this.state && this.close());
        const e = yield Mr.enumerateDevices();
        Gs(t)
          ? (this._device = e[t])
          : ((this._device = e.find((e) => e.label === t || e.deviceId === t)),
            !this._device && e.length > 0 && (this._device = e[0]),
            Js(Zs(this._device), `No matching device ${t}`));
        const n = {
          audio: {
            echoCancellation: !1,
        ...
        if (!this._stream) {
          ...
          (oo(t, this.output), (this._mediaStream = t));
        }
        return this;
      });
    }
    ...
    static get supported() {
      return (
        Zs(navigator.mediaDevices) && Zs(navigator.mediaDevices.getUserMedia)
      );
    }
  }
  var Dr = class {
    ...
    connect(t) {
      "function" == typeof t.getNode
        ? this.audioIn.connect(t.getNode())
        : this.audioIn.connect(t);
    }
    disconnect() {
  ...
  ((p5.prototype.getAudioContext = function () {
    return (ji(new window.AudioContext()), Wi()._context);
  }),
    (p5.prototype.setAudioContext = function (t) {
      ji(t);
    }),
    ...
    (p5.prototype.userStopAudio = function () {
      ((context = Wi()), context.suspend());
    }),
    (p5.Oscillator = No),
    (p5.SawOsc = class extends Ro {
      constructor(t) {
        (super(t), (this.osc.type = "sawtooth"));
      }
    }),
    (p5.SinOsc = class extends Ro {
      constructor(t) {
        (super(t), (this.osc.type = "sine"));
      }
    }),
    (p5.TriOsc = class extends Ro {
      constructor(t) {
        (super(t), (this.osc.type = "triangle"));
      }
    }),
    (p5.SqrOsc = class extends Ro {
      constructor(t) {
        (super(t), (this.osc.type = "square"));
      }
    }),
    (p5.Envelope = Bo),
    (p5.Delay = Yo),
    (p5.Reverb = tr),
    (p5.Biquad = sr),
    (p5.LowPass = class extends nr {
      constructor(t) {
        (super(t), (this.biquad.type = "lowpass"));
      }
    }),
    (p5.HighPass = class extends nr {
      constructor(t) {
        (super(t), (this.biquad.type = "highpass"));
      }
    }),
    (p5.BandPass = class extends nr {
      constructor(t) {
        (super(t), (this.biquad.type = "bandpass"));
      }
    }),
    (p5.PitchShifter = lr),
    (p5.Gain = dr),
